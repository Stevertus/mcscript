...
function TokenStream(input) {
  var current = null;
  var keywords = " if then else lambda Î» true false for as at positioned modal align dimension rotated anchored ";
  return {
    next  : next,
    peek  : peek,
    eof   : eof,
...
exports.lexer = function(str){
  ...
  return TokenStream(InputStream(str))
}
