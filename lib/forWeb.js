...
var TokenStream = function(input) {
  var current = null;
  var keywords = " override if then else true false for as at asat positioned modal align dimension rotated anchored while do forEach raycast stop continue switch case default var bool boolean tag score const ";
  return {
    next  : next,
    peek  : peek,
    eof   : eof,
