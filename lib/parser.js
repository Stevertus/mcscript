...
//parse means parse the source code of mcscript into a object that represents a syntax tree
exports.parse = function (input) {
	...
	function parse_call(func) {
		ret = {
			type: "call",
			func: func, // name of the function, not body
	...
	function parse_atom() {
		return maybe_call(function () {
			...
			if (is_kw("asat") || is_kw("as") || is_kw("at") || is_kw("positioned") || is_kw("align") || is_kw("rotated") || is_kw("anchored") || is_kw("dimension") || is_kw("in")) return parse_keyword(input.peek().value);
