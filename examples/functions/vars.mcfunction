#######
# Compiled from .//functions/variables.mcscript
# to .//functions/vars.mcfunction
#
...
# saving a command result in variable
execute store result score varResult varResult run data get entity @s Pos[0]